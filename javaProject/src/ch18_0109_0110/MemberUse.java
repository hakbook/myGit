...
public class MemberUse {
	public static void main(String[] args) {
		...
		MemberDTO m1 = new MemberDTO("kim", "김진", "1234", 30, "kim@gmail.com");
		MemberDTO m2 = new MemberDTO("lee", "이온", "1234", 20, "lee@gmail.com");
		MemberDTO m3 = new MemberDTO("park", "박정", "1234", 40, "park@gmail.com");
		try {
			//직렬화 : 메모리 => 프로그램 => 파일
