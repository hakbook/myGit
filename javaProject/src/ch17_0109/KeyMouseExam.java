...
public class KeyMouseExam extends JApplet implements MouseListener, MouseMotionListener, KeyListener {
	...
	private boolean flag = false;//이미지가 처음 실행할땐 안보이게 false로씀
	...
	public void keyPressed(KeyEvent e) {
		...
		//max(값,값) 앞의 값과 뒤의 값 중 최대값 구함. min(값,값) 최소값들을 리턴반아
	...
	//컴퍼넌트상에서 마우스 버튼을 클릭(눌렀다가 놓을때)했을 때 호출.
	@Override
